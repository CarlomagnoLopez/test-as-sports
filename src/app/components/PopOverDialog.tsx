                ...
                <DialogFooter
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6 mr-2">
                        <button
                            ...
                            className="rounded-md px-3 py-2 text-sm font-semibold shadow-sm hover:bg-indigo-30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-100"
                        >
                            Lo pensare mejor
                        </button>
                    </div>
